...
int main()
{
    ...
    // array<int, 5> arr;
    // one more methond to represent array now this will take all garbage value if it is inside the main and if it is outside the main then the value will become zero by deafaulf
